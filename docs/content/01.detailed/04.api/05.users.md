...
- `@login_required`： ログインを要求する。
- `@roles_required`： ログインユーザーに「システム管理者」または「リポジトリ管理者」のロールを要求する。
- `@validate`： モデルクラスを使用してリクエストとレスポンスのバリデーションを行う。
...
#### デコレータ
- `@bp.post`： POST リクエストを処理するエンドポイントを定義する。
- `@login_required`： ログインを要求する。
- `@roles_required`： ログインユーザーに「システム管理者」または「リポジトリ管理者」のロールを要求する。
- `@validate`： モデルクラスを使用してリクエストとレスポンスのバリデーションを行う。
...
#### デコレータ
- `@bp.delete`： DELETE リクエストを処理するエンドポイントを定義する。
- `@login_required`： ログインを要求する。
- `@roles_required`： ログインユーザーに「システム管理者」のロールを要求する。
- `@validate`： モデルクラスを使用してリクエストとレスポンスのバリデーションを行う。
